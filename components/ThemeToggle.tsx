  ...
  return (
    <div className="toggle-container flex items-center justify-between">
      ...
      <div className="button-container flex items-center flex-col">
        ...
        <button onClick={toggleTheme} className={`theme-toggler rounded-full w-[71px] h-[26px] flex items-center justify-center transition duration-300
          ${
            theme === "dark"
            ? "bg-theme1-toggleBg"
            : theme === "light"
          ...
          {theme === "light" && <span className="sr-only">Switch to Dark</span>}
          {theme === "alt" && <span className="sr-only">Switch to Light</span>}
          {theme === "dark" && <span className="sr-only">Switch to Alt</span>}
          <div
